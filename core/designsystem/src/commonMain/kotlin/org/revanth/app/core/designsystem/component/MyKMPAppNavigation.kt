 ...
 */
@Composable
fun RowScope.MyKMPAppNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
 ...
 */
@Composable
fun MyKMPAppNavigationRailItem(
    selected: Boolean,
    onClick: () -> Unit,
    icon: @Composable () -> Unit,
    modifier: Modifier = Modifier,
...
fun MyKMPAppNavigationRail(
    ...
    NavigationRail(
        ...
        contentColor = MyKMPAppNavigationDefaults.navigationContentColor(),
        header = header,
        content = content,
    )
}
...
@Preview
@Composable
fun MyKMPAppNavigationBarPreview() {
...
@Preview
@Composable
fun MyKMPAppNavigationRailPreview() {
    val items = listOf("Home", "Payments", "Finance", "Profile")
    val icons =
        listOf(
            AppIcons.Home,
 ...
 */
object MyKMPAppNavigationDefaults {
    @Composable
