...
fun MyKMPAppScaffold(
    ...
    pullToRefreshState: MyKMPAppPullToRefreshState = rememberMyKMPAppPullToRefreshState(),
...
data class MyKMPAppPullToRefreshState(
...
@Composable
fun rememberMyKMPAppPullToRefreshState(
    isEnabled: Boolean = false,
    isRefreshing: Boolean = false,
    onRefresh: () -> Unit = { },
): MyKMPAppPullToRefreshState = remember(isEnabled, isRefreshing, onRefresh) {
    MyKMPAppPullToRefreshState(
        isEnabled = isEnabled,
