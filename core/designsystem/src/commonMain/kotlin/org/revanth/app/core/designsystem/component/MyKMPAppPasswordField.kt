...
import org.revanth.app.core.designsystem.utils.nonLetterColorVisualTransformation
import org.revanth.app.core.designsystem.utils.tabNavigation

@Composable
fun MyKMPAppPasswordField(
    label: String,
    value: String,
...
@Preview
@Composable
private fun MyKMPAppPasswordField_preview_withInput_hidePassword() {
    MyKMPAppPasswordField(
        label = "Label",
        value = "Password",
        onValueChange = {},
...
@Preview
@Composable
private fun MyKMPAppPasswordField_preview_withInput_showPassword() {
    MyKMPAppPasswordField(
        label = "Label",
        value = "Password",
        onValueChange = {},
...
@Preview
@Composable
private fun MyKMPAppPasswordField_preview_withoutInput_hidePassword() {
    MyKMPAppPasswordField(
        label = "Label",
        value = "",
        onValueChange = {},
...
@Preview
@Composable
private fun MyKMPAppPasswordField_preview_withoutInput_showPassword() {
    MyKMPAppPasswordField(
        label = "Label",
        value = "",
        onValueChange = {},
